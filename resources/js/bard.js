...
import GlossaryTooltipsToolbarButton from './GlossaryTooltipsToolbarButton';

Statamic.$bard.addExtension(() => GlossaryTooltips);
Statamic.$bard.buttons(() => {
    return ({
        ...
        component: GlossaryTooltipsToolbarButton,
    })
});
